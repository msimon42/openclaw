...
export type AppViewState = {
  ...
  wizardStartMode: "local" | "remote";
  wizardStartProfile: "standard" | "enhanced";
  wizardStartNonInteractive: boolean;
  wizardStartForceReset: boolean;
  wizardAnswerText: string;
  wizardAnswerConfirm: boolean;
  wizardAnswerValue: unknown;
  wizardAnswerMultiValues: unknown[];
  basePath: string;
  connected: boolean;
  theme: ThemeMode;
