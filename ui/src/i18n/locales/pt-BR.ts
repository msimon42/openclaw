...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    onboarding: "Fluxo de configuração guiado pelo gateway para perfis locais e remotos.",
    ...
    observability: "Telemetria em tempo real de modelo, ferramentas e roteamento.",
    inbox: "Fila de ações recebidas com encaminhamento rápido para workers.",
    delegation: "Atividade de chamadas, mensagens e artefatos entre agentes.",
