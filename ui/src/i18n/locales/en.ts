...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    onboarding: "Gateway-first setup flow for local and remote connection profiles.",
    ...
    observability: "Live model, tool, and routing telemetry for active runs.",
    inbox: "Incoming action queue with quick worker handoff and promotion controls.",
    delegation: "Cross-agent calls, messages, and artifact flow activity.",
