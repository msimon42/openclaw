...
import {
  ...
  AgentsMessageResultSchema,
  AgentsCallLimitsSchema,
  AgentsCallParamsSchema,
  AgentsCallResultSchema,
  ArtifactsPublishParamsSchema,
  ArtifactsPublishResultSchema,
  ArtifactsFetchParamsSchema,
  ArtifactsFetchResultSchema,
  DelegationArtifactRefSchema,
...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  DelegationArtifactRef: DelegationArtifactRefSchema,
  AgentsMessageParams: AgentsMessageParamsSchema,
  AgentsMessageResult: AgentsMessageResultSchema,
  AgentsCallLimits: AgentsCallLimitsSchema,
  AgentsCallParams: AgentsCallParamsSchema,
  AgentsCallResult: AgentsCallResultSchema,
  ArtifactsPublishParams: ArtifactsPublishParamsSchema,
  ArtifactsPublishResult: ArtifactsPublishResultSchema,
  ArtifactsFetchParams: ArtifactsFetchParamsSchema,
  ArtifactsFetchResult: ArtifactsFetchResultSchema,
